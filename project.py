...
# New imports for the login session
from flask import session as login_session
import random
import string

# Importscd for GConnect function
...
# Provide login functionality using Google's OAuth2 feature
...
def gconnect():
    ...
    if stored_access_token is not None and gplus_id == stored_access_token:
        response = make_response(
            json.dumps("Currently user is already connected.", 200))
        response.headers['Content-Type'] = 'application/json'
        return response
